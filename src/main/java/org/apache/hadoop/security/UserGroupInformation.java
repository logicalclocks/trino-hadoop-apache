...
import static io.hops.security.SuperuserKeystoresLoader.SUPER_MATERIAL_DIRECTORY_ENV_VARIABLE;
...
public class UserGroupInformation {
  ...
  public static class HadoopLoginModule implements LoginModule {
    ...
    private String extractUsernameFromX500Principal(X500Principal principal) {
      ...
      // Try to extract L= (Locality) first, then CN= (Common Name)
